    ...
    while True:
        ...
        if command[0] == "clear_board":
            ...
            if command[2] == "pass":
                ...
                go_state_obj = rule.move_and_return_state(go_state_obj, player, (x, y))
                #player.player_id
            ...
            if command[1] == "b":
                ...
                player = players[1]
            #(go_state_obj, move) = search_algorithm.next_move(forward_prop_network,sess,go_state_obj, player,last_opponent_move)
            (go_state_obj, move) = search_algorithm.next_move(go_state_obj, player,1800-(float(300)),last_opponent_move)
            #tup=[move[0],move[1]]
            ...
            if move == "pass":
                ...
                sys.stderr.write(rule.print_board(go_state_obj))
                sys.stderr.write(str("turns_since_board"))
                sys.stderr.write(str(rule.print_board(go_state_obj)))
