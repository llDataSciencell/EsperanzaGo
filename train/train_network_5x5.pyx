    ...
    def train(self):
        ...
        with tf.variable_scope('policy_auto'):
            with tf.device("/gpu:0"):
                ...
                # 3x3フィルタで64チャネルを出力
                W_conv2 = self.weight_variable([5, 5, 75, 75])  #[3,3,50,100]
                ...
                ###5層目 畳み込み層
                W_conv3 = self.weight_variable([5, 5, 75, 75])
                ...
                ###7層目　畳み込み層
                W_conv4 = self.weight_variable([5, 5, 75, 75])
                ...
                h_pool6_flat = tf.reshape(h_pool5, [-1, 19 * 19 * 75])#29*29*100

                weight_fully_connected1=self.weight_variable([19*19*75,1000])
        ...
        with tf.Session() as sess:
            ...
            #saver.restore(sess, './Network_Backup/policy_network_3x3_default')
                        ...
                        try:
                            ...
                            for game in collection:
                                for node in game:
                                    ...
                                    if (batch_count_sum_all+101) % 40 == 0 and batch_count_num == 30:
                                        #print xTrain
                                    ...
                                    if train_count_num > 2000:
                                        ...
                                        ckpt_num+=1
                                        print "SAVED!"
                                        saver.save(sess,'./Network_Backup/policy_network_5x5_conv'+ str(ckpt_num) )
