    ...
    def train(self):
        ...
        with tf.device("/gpu:0"):
            ...
            with tf.variable_scope('large_policy'):
                ...
                h_conv9 = tf.nn.relu(conv2d(conv8_bn, W_conv9) + b_conv9)
        ...
        with tf.device("/gpu:1"):
            ...
            with tf.variable_scope('large_policy'):
                ...
                conv10_bn = batch_normalization(n_out,h_conv10)
                            ...
                            for game in collection:
                                for node in game:
                                    ...
                                    if train_count_num > 1500:
                                        ...
                                        ckpt_num += 1
                                        print "SAVED!"
                                        saver.save(sess, './Network_Backup/13layer_new_large_policy' + str(ckpt_num))
